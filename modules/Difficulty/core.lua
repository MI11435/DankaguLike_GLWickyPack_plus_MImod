...
function MIdelay()
	...
	if (diffX) then
		CreateLyricCanvas(WickyCanvas, "TextDifficultyShadow", Vector3(-33, 28, 0), diffColor, diffText .. ' X', size)
		CreateLyricCanvas(WickyCanvas, "TextDifficulty", Vector3(-35, 30, 0), util.ColorRGB(255, 255, 255),
			diffText .. ' X', size)
	else
		CreateLyricCanvas(WickyCanvas, "TextDifficultyShadow", Vector3(-33, 28, 0), diffColor,
			diffText .. ' ' .. diffMeter, size)
		CreateLyricCanvas(WickyCanvas, "TextDifficulty", Vector3(-35, 30, 0), util.ColorRGB(255, 255, 255),
			diffText .. ' ' .. diffMeter, size)
	end
end

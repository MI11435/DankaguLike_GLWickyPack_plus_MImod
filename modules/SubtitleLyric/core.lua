...
execute.onloaded = function(e)
  ...
  local Lyric1 = ACTORFACTORY:CreateUIText()
  Lyric1.gameObject.name = "Lyric1"
  Lyric1.gameObject.transform:SetParent(canvas.transform, false)
  Lyric1.gameObject:AddComponent(typeof(UnityEngine.CanvasRenderer))
  _Lyric1Text = Lyric1:GetTextMeshProUGUI()
  ...
  _Lyric1Text.alignment = CS.TMPro.TextAlignmentOptions.Top
  _Lyric1Text.outlineWidth = 0.17
  _Lyric1Text.text = ""

  local Lyric2 = ACTORFACTORY:CreateUIText()
  Lyric2.gameObject.name = "Lyric2"
  Lyric2.gameObject.transform:SetParent(canvas.transform, false)
  Lyric2.gameObject:AddComponent(typeof(UnityEngine.CanvasRenderer))
  _Lyric2Text = Lyric2:GetTextMeshProUGUI()
  ...
  _Lyric2Text.alignment = CS.TMPro.TextAlignmentOptions.Top
  _Lyric2Text.outlineWidth = 0.17
  _Lyric2Text.text = ""
end

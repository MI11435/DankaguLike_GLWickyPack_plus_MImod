...
function onloaded()
	...
	if platform == 3 or platform == 4 then
		parentDir = CS.UnityEngine.Application.persistentDataPath .. "/GlobalLua/GLWPpMI_2.5.1/"
	else
		parentDir = Path.GetDirectoryName(Assembly.GetExecutingAssembly().Location) .. "\\GlobalLua\\GLWPpMI_2.5.1\\"
	end
